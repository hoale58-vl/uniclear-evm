...
import "./IBidStorage.sol";
import "./IDistributionContract.sol";
import "./ICheckpointStorage.sol";
import "./ITickStorage.sol";
import "./ITokenCurrencyStorage.sol";
import "./IStepStorage.sol";
...
/// @notice Validation hook interface
interface IValidationHook {
    function validate(address bidder, uint256 amount, bytes calldata data) external view;
}
